...
public class MobileGestures {
     ...
     */
    public static void selectPickerWheelValue(RemoteWebElement element) {
        JavascriptExecutor js = Drivers.getMobileDriver();
        Map<String, Object> params = new HashMap<>();
    ...
    public static void selectPickerWheelValue2(By by) {
        JavascriptExecutor js = Drivers.getMobileDriver();
        Map<String, Object> params = new HashMap<>();
        params.put("order", "next");
        params.put("offset", 0.15);
    ...
    public static void selectPickerWheelValueMobile(MobileElement by) {
        JavascriptExecutor js = Drivers.getMobileDriver();
        Map<String, Object> params = new HashMap<>();
        params.put("order", "next");
        params.put("offset", 0.15);
