...
public class ADB {
    ...
    private String getAndroidVersionAsString() {
    ...
    public void openAppsActivity(String packageID, String activityID) {
        command("adb -s " + ID + " shell am start -c api.drivers.intent.category.LAUNCHER -a api.drivers.intent.action.MAIN -n " + packageID + "/" + activityID);
    }
