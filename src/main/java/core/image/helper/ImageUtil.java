...
public class ImageUtil {
     ...
     */
    private static void cropImageForTesting(String newFilePathAndName,
    ...
    public static void saveImageAsArtefact(File f, String name) {
        ...
        try {
            ...
            log.info("ImageUtil stored in " + fileName);
        } catch (IOException e) {
    ...
    private static boolean isPixelTheSame(int xCoordinate, int yCoordinate,
    ...
    private static boolean isColorTheSame(Color c1, Color c2, int offset) {
        ...
        if (c1.getRGB() == c2.getRGB()) {
            return true;
        } else return (Math.abs(c1.getRed() - c2.getRed()) < offset)
